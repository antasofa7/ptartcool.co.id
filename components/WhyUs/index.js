        ...
        <div className="container">
            <div className={styles.row}>
                <div className={styles.col}>
                    <div className={styles.icon}>
                        <svg width="100%" height="100%" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20 13V23L24.3333 26.3333" stroke="#F5FFFE" strokeWidth="3" strokeLinecap="round" />
                            <circle cx="21" cy="21" r="14.5" stroke="#F5FFFE" strokeWidth="3" />
                        </svg>
                    </div>
                ...
                <div className={styles.col}>
                    <div className={styles.icon}>
                        <svg width="100%" height="100%" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.8 21.5333L18.92 24.7333L26.2 18.3333" stroke="#F5FFFE" strokeWidth="3" strokeLinecap="round" />
                            <path d="M32.5 13.9848V35C32.5 35.2761 32.2761 35.5 32 35.5H10C9.72386 35.5 9.5 35.2761 9.5 35V7C9.5 6.72386 9.72386 6.5 10 6.5H22.9198C23.03 6.5 23.1372 6.53645 23.2246 6.60369L32.3049 13.5885C32.4279 13.6831 32.5 13.8296 32.5 13.9848Z" stroke="#F5FFFE" strokeWidth="3" />
                        </svg>
                    </div>
                    <div className={styles.wrapper}>
                        <h4>+100</h4>
